package com.devonfw.module.kafka.logic;
...
import com.devonfw.module.kafka.producer.KafkaConverter;
...
public class KafkaProducerLogic {
  ...
  public KafkaRecordMetaData sendMessage(String topic, String msg) {
	...
	try {
		System.out.println(" Send message topic is not null") ;
		producer = new KafkaMessageProducer();
		System.out.println(" Producer is not  null") ;
	} catch (Exception e) {
    ...
    System.out.println(" Producer send messsage  is called") ;
